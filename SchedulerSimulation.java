...
public class SchedulerSimulation {
    ...
    public static void main(String[] args) {
        ...
        for (int i = 1; i <= numProcesses; i++) {
            ...
            // priority
            // feature 1: Pass priority to the Process constructor
            // Process names will be P1, P2, ..., Pn based on the loop index
        ...
        while (!processQueue.isEmpty()) {
            ...
            // feature 2: Increment context switch count each time a new thread starts
    ...
    public static void addProcessToQueue(Process process, Queue<Thread> processQueue,
        ...
        // feature 1: Print the priority of the process when it is added to the ready
        // queue
        // Print a message indicating the process has entered the ready queue
        System.out.println(Colors.CYAN + process.getName() +
